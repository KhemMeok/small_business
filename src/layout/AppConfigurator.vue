...
const primaryColors = ref([
  ...
  { name: 'htbSignature', palette: { 50: '#e0f7f8', 100: '#b3ecee',200: '#80dfe3',300: '#4dd2d9',400: '#26c7d0', 500: '#009da5', 600: '#008d94', 700: '#00777e', 800: '#005f66', 900: '#00484d', 950: '#002f33' }},
  { name: 'custom-teal', palette: { 50: '#f2fefe', 100: '#e6fcfd', 200: '#d9fbfd', 300: '#ccf6fa', 400: '#bff3f8', 500: '#b2f0f6', 600: '#a5edf4', 700: '#99ebf2', 800: '#8ce8f0', 900: '#80e6ee', 950: '#009da5' } }
]);
...
function applyTheme(type, color) {
  if (type === 'primary') {
    ...
    localStorage.setItem('app-primary', layoutConfig.primary);
  } else if (type === 'surface') {
    updateSurfacePalette(color.palette);
    localStorage.setItem('app-surfaces', layoutConfig.surface);
  }
}

function onPresetChange() {
  layoutConfig.preset = preset.value;
  localStorage.setItem('app-preset', layoutConfig.preset);
...
function onMenuModeChange() {
  ...
  localStorage.setItem('app-menuMode', layoutConfig.menuMode);
}
